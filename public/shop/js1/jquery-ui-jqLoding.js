...
; (function ($) { 
    $.fn.jqLoading =function(option) {
        var defaultVal = {
            ...
            backgroundImage: "/template/wap/statics/images/loading.gif",//背景图片
            text: "正在加载中，请耐心等待....",//文字 
            width: 150,//宽度
            height: 50,//高度
            type:0 //0全部遮，1 局部遮
        ...
        function openLayer() {
           ...
           //图片及文字层
            ...
            //<img style='vertical-align:middle;margin:"+(opt.height/4)+"px; 0 0 5px;margin-right:5px;' src='" + opt.backgroundImage + "' />
